...
//        JOptionPane.showMessageDialog(null,rollNo1);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 67, 1366, -1));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("During the  Exam :\n\n1 - The student may not use his or her textbook , coarse notes or any other means during the exam.\n2 - Students must have to complete all the given multiple choice questions within the time slot.\n3 - Student must not stop the session and then return to it.\n4- Students must have to check their internet connection before staring the exam.\n5 - For any other quries kindly contact the administrator or mail your quries on abc@gmail.com\n");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 76, 1366, 283));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 372, -1, -1));
