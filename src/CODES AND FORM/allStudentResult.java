...
public class allStudentResult extends javax.swing.JFrame {
    ...
    public allStudentResult() {
        ...
        try
        {
            ...
            PreparedStatement pstat = con.prepareStatement("select * from student",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
...
//           ResultSet rs= st.executeQuery("select * from student");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 950, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 95, 155, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 146, 1066, 441));
